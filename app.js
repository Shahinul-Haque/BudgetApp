...
var Controller = (function(budgetCntrl,UICntrl){
    ...
    var setupEventListners = function(){
       ...
       var DomString = UICntrl.getDomStrings();
       document.querySelector(DomString.inputBtn).addEventListener('click',cntrlAddItem); 
       ...
       document.querySelector(DomString.container).addEventListener('click',cntrlDeleteItem);
       document.querySelector(DomString.inputType).addEventListener('change',UICntrl.changeType)
